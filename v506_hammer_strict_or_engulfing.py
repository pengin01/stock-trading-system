# v506_hammer_strict_or_engulfing.py
# -*- coding: utf-8 -*-
    ...
    for d in dates:
        ...
        if len(pos) < MAX_POSITIONS:
            for t, df in data.items():
                ...
                elif hammer and vol >= vol20 * HAMMER_VOL_MULT:
                    signal = "hammer_strict"
