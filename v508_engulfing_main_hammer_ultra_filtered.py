# v508_engulfing_main_hammer_ultra_filtered.py
    ...
    for d in dates:
        ...
        if len(pos) < MAX_POSITIONS:
            for t, df in data.items():
                ...
                elif hammer and close > open_ and vol >= vol20 * HAMMER_VOL_MULT:
                    signal = "hammer_ultra"
...
print("\n=== WALK FORWARD : ENGULFING MAIN + HAMMER ULTRA + FILTER v508 ===")
