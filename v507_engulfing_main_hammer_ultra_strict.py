# v507_engulfing_main_hammer_ultra_strict.py
        ...
        if len(pos) < MAX_POSITIONS:
            for t, df in data.items():
                ...
                if engulfing:
                    ...
                    hammer
                    and close > open_  # 陽線のみ
                    and vol >= vol20 * HAMMER_VOL_MULT
                ):
                    signal = "hammer_ultra"
...
print("\n=== WALK FORWARD : ENGULFING MAIN + HAMMER ULTRA v507 ===")
